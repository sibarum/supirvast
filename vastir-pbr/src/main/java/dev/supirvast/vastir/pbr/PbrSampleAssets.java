...
public final class PbrSampleAssets {
    ...
    /**
     * A UV sphere as Wavefront OBJ with explicit normals, centered at {@code (0,0,zCenter)} in clip space.
     * Normals are the unit sphere directions; positions are {@code center + radius*normal}.
     */
    static String sphereObj(int stacks, int slices, float radius, float zCenter) {
        ...
        // Quad faces between adjacent rings/segments (1-based; vn index == v index). Pole quads degenerate
